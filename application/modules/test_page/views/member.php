        ...
        <div id="page-content-container" class="col m12 l12">
            ...
            <div id="upload" class="modal modal-fixed-footer">
                    ...
                    <form action="#" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="row">
                            <div class="input-field col s12">
                                    <input placeholder="Video title" id="title" type="text" class="validate">
                            ...
                            <div class="input-field col m5">
                                ...
                                <div class="input-field col s12">
                                    <textarea id="description" class="materialize-textarea" row="2"></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <a id="Upload" class=" modal-action modal-submit waves-effect waves-green btn red darken-4">Save</a>
                </div>
            </div>
        </div>
    </div>
